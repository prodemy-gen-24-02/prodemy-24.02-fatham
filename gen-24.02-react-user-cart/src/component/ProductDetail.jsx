...
const ProductDetail = ({ product, colors, sizes }) => {
    ...
    const handleAddToCart = async () => {
        ...
        try {
            ...
            alert("Harap Login terlebih dahulu untuk menambahkan ke Cart")
            ...
            <div className="grid grid-cols-1 mt-2 md:grid-cols-2 gap-8 bg-white text-left">
                ...
                <div>
                    ...
                    <h4 className="flex items-center mb-4">
                        <span className="text-xl text-gray-400 line-through tracking-wide">${product.originalPrice}</span>
                        <span className="text-xl text-gray-900 tracking-wide indent-2">${product.discountedPrice}</span>
                    </h4>
                    <p className="text-gray-700 mb-4">4 interest-free installments, or from $13.90/mo with shopPay</p>
                    <a href="#" className="underline">Check your purchasing power</a>
                    <div className="flex items-center mt-4 mb-4">
                        <img src={star} alt="star" /><span>14 Reviews</span>
                    </div>
                    ...
                    <button id="cart"
                        className="bg-black text-white py-3 w-full hover:bg-gray-800 transition duration-300 mb-4" onClick={handleAddToCart}
                    ...
                    <a href="#" className="underline mb-4">Women Size Guide</a>
                    <p>SHARE</p>
                </div>
            </div>
        </div>
